      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl p-8 md:p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/Brochure-SupFinance-Preparation-au-CFA-Level1-2025-2026-Public.pdf"
              download="Brochure-SupFinance-Preparation-au-CFA-Level1-2025-2026-Public.pdf"
              className="inline-flex items-center px-6 py-3 border-2 border-white text-white hover:bg-white hover:text-cyan-600 font-semibold bg-transparent rounded-md transition-all duration-300 text-lg"
            >
              <FileSpreadsheet className="w-5 h-5 mr-2" />
              {t("formations.cta.download")}
            </a>
          </div>
        </div>
      </div>
