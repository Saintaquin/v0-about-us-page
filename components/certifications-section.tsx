...
export default function CertificationsSection() {
  ...
  const handleDownloadBrochure = () => {
    ...
    link.href = '/Brochure-SupFinance-Préparation-au-CFA-Level1-2025-2026-Public.pdf'
    link.download = 'Brochure-SupFinance-Préparation-au-CFA-Level1-2025-2026-Public.pdf'
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button 
                    ...
                    onClick={cert.featured ? handleDownloadBrochure : undefined}
                  >
                    {cert.featured ? (
