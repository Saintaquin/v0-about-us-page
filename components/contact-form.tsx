...
import { Mail, Phone, Send, CheckCircle2, Calendar, ArrowRight } from "lucide-react"
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            ...
            <div className="rounded-xl flex flex-col items-start space-y-4">
    

              <Button
                onClick={() => window.open("https://calendly.com/supfinance/15min", "_blank")}
                className="group bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 text-white font-semibold transition-all duration-300 ease-out hover:scale-105 hover:shadow-lg border-0 px-6 py-3"
                size="default"
              >
